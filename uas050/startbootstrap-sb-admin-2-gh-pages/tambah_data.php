          ...
          <form method="post" enctype="multipart/form-data" action="simpan_data.php">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <!-- kode barang di buat otomatis, karena kode barang harus unik, tidak boleh sama dengan yg lain -->
                <input type="number" class="form-control" id="" name="kode_barang" value="<?= date('ymd') . rand(100, 999); ?>" readonly>
              </div>
